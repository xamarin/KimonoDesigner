...
namespace KimonoCore.Mac
{
	...
	/// </summary>
	[Register("KimonoGradientDesignPreview")]
	public class KimonoGradientDesignPreview : NSImageView
	{
		...
		/// </summary>
		public KimonoGradientDesignPreview()
		{
		}
		...
		public KimonoGradientDesignPreview(IntPtr handle) : base(handle)
		{
		...
		public KimonoGradientDesignPreview(CGRect frameRect) : base(frameRect)
		{
		}
		...
		public KimonoGradientDesignPreview(NSCoder coder) : base(coder)
		{
		}
		#endregion
		...
		public override void MouseDown(NSEvent theEvent)
		{
			...
			Gradient.PreviewToolDown(point, (int)theEvent.ClickCount, shiftKeyDown);
		}
		...
		public override void MouseDragged(NSEvent theEvent)
		{
			...
			Gradient.PreviewToolDrag(point);
			RefreshView();
		}
